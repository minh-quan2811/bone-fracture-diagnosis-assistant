...
export default function Home() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-blue-50 via-white to-purple-50 m-0 p-0">
      {/* Navigation Bar */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          ...
          <div className="mb-8">
            ...
            <button
              onClick={handleGoToLogin}
              className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold text-lg rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all shadow-xl hover:shadow-2xl transform hover:-translate-y-0.5"
            >
              Get Started
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            {/* Feature 1 */}
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-gray-300 hover:shadow-xl hover:border-blue-500 transition-all">
            ...
            {/* Feature 2 */}
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-gray-300 hover:shadow-xl hover:border-purple-500 transition-all">
            ...
            {/* Feature 3 */}
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-gray-300 hover:shadow-xl hover:border-indigo-500 transition-all">
